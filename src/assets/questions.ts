...
export const questions: QuestionInterface[] = [
  ...
  {
    id: 5,
    question: 'Sind diese Prozesse sehr fehleranfällig und/oder verarbeiten sensible Daten?',
    explanation: 'Robotic Process Automation (RPA) kann dazu beitragen, die Genauigkeit von Prozessen zu erhöhen und Fehler zu reduzieren, besonders wenn diese Prozesse repetitive und datenintensive Aufgaben beinhalten. Daher könnte die Verwendung von RPA besonders nützlich sein, wenn Ihre Prozesse anfällig für menschliche Fehler sind. Ebenso kann RPA dazu beitragen, die Sicherheit und Genauigkeit beim Umgang mit sensiblen Daten zu erhöhen, da Bots konsequent die vorgeschriebenen Sicherheitsprotokolle befolgen. Denken Sie bei dieser Frage an die Fehlerquote in Ihren Prozessen und die Art der Daten, die sie verarbeiten.',
    subQuestions: [
  ...
  {
    id: 6,
    question: 'Wird der Prozess häufig durchgeführt?',
    explanation: 'Die Frequenz, mit der ein Prozess ausgeführt wird, kann ein wichtiger Indikator dafür sein, ob die Automatisierung durch Robotic Process Automation (RPA) sinnvoll ist. RPA ist besonders nützlich für wiederholbare Aufgaben, die regelmäßig und in hohem Volumen ausgeführt werden. Wenn ein Prozess nur selten ausgeführt wird, sind die Zeit- und Kostenersparnisse, die durch die Automatisierung erreicht werden können, möglicherweise nicht so signifikant. Denken Sie darüber nach, wie oft der Prozess durchgeführt wird - täglich, wöchentlich, monatlich oder weniger oft.',
    subQuestions: [
      'Wird der Prozess in einer typischen Woche häufig ausgeführt?',
      'Wird der Prozess das ganze Jahr über gleichmäßig durchgeführt oder ist der Prozess saisonabhängig?' //???
    ],
    weight: 5
  },
  {
